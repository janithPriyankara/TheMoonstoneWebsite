...
const Portfolio = () => {
  ...
  const categoriesData = {
    ...
    'Architectural Design': {
      ...
      description: 'Innovative residential and commercial architecture',
      mainImage: img2,
      slideImages: [img2, img4, img1],
      projects: [
        {
          id: 2,
          ...
          teamSize: "12 members",
          duration: "10 months",
          details: "A modern residential complex featuring energy-efficient design, communal spaces, and innovative use of natural light. The design incorporates sustainable materials and smart home technologies."
        },
        {
          id: 13,
          title: "Contemporary Office Building",
          description: "Sustainable office design with modern amenities.",
          image: img4,
          tags: ["Commercial", "Sustainable", "Office"],
          year: "2024",
          location: "Negombo, Sri Lanka",
          teamSize: "15 members",
          duration: "12 months",
          details: "A cutting-edge office building designed for maximum energy efficiency and employee wellness. Features include green roofs, natural ventilation systems, and flexible workspace configurations."
        }
      ]
    },
    'Building Renovation': {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Showcasing our diverse range of projects across multiple disciplines. Hover over categories to see previews, click to explore detailed project galleries.
          </p>
        </div>
