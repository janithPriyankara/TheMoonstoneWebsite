    ...
    <section id="about" className="py-20 bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          <div>
            <h3 className="text-2xl font-bold text-white mb-6">Our Foundation</h3>
            ...
            <div className="bg-gray-800 p-6 rounded-lg">
              <p className="text-blue-400 font-semibold">Registration No.: PV00325510</p>
              <p className="text-blue-300 mt-2">Sanasuma, Wawlagala, Baddegama, Sri Lanka</p>
            </div>
          </div>
        ...
        <div className="bg-gray-800 rounded-lg shadow-lg p-8">
          <h3 className="text-2xl font-bold text-white mb-6 text-center">Our Core Services</h3>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
              <div className="bg-blue-900 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <div className="w-8 h-8 bg-blue-600 rounded"></div>
              </div>
              <h4 className="font-semibold text-white mb-2">Electronics Design</h4>
              <p className="text-sm text-gray-300">Embedded systems and high-performance electronics design</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-300">Full-stack software products and engineering tools</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-300">Architectural consultation and creative design solutions</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h4 className="font-semibold text-white mb-2">Manufacturing</h4>
              <p className="text-sm text-gray-300">Custom PCB design and 3D printing services</p>
            </div>
          </div>
        </div>
      </div>
